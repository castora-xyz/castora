...
export default function BottomNav() {
  ...
  return (
    <nav className="sm:hidden py-2 fixed bottom-0 left-0 right-0 z-10 border-t border-border-default dark:border-surface-subtle bg-app-bg font-medium text-sm md:text-base">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              ...
              `${
                ...
                location.pathname == '/' 
                // TODO: Remove slash checker above after building landing page
