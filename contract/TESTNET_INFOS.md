...
Information regarding the Allowed Pool Rules, Contract CHANGELOGs, and Foundry commands for Castora contracts deployed in the Monad Testnet.

## Allowed User Pool Rules

The permitted settings for user-created pools in the Monad Testnet are as follows:
...
Foundry Docs are at https://book.getfoundry.sh/

Following are useful foundry commands:
